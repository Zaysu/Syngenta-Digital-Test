class Hoteis:
    ...
    def valoresHoteis(self):
        ...
        if self.dataEntrada >= 1 and self.dataEntrada < 32 and self.dataSaida >= 1 and self.dataSaida < 32 and self.dataEntrada < self.dataSaida:
            ...
            ######-----------desempate-----------########
             ...
             return "Não há disponibilidade de hotel para o período solicitado"